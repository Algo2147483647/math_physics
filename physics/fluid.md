...
Density field + velocity field + pressure field + temperature field.
...
### Conservation of momentum: Equation of motion: Navier Stokes Equations
...
$$
Mass is neither created nor destroyed out of thin air. 质量流流出速率 = 流体密度减少速率.
...
### Equation of state: relates p, ρ, T, and e.
