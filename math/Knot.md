...
> A knot is an embedding of a circle in three-dimensional space, studied up to continuous deformation.
...
- [Euclidean_Space](./Euclidean_Space.md): has_ambient_space
